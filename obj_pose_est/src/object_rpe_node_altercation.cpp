...
int main()
{
  ...
  std::string depth_path = "/media/martin/Innehåller/datafortrain/datafromlabelfusion/4/images/"+numberstring+"-depth.png";  //<--------------- Change number
  std::string rgb_path = "/media/martin/Innehåller/datafortrain/datafromlabelfusion/4/images/"+numberstring+"-color.png";   //<--------------- Change number
  std::string rgb_label_path = "/media/martin/Innehåller/datafortrain/datafromlabelfusion/4/images/"+numberstring+"_color_labels.png";  //<--------------- Change number
  std::string label_path = "/media/martin/Innehåller/datafortrain/4/4"+numberstring+"/scan.labels";    //<--------------- Change number  
  std::string depthrgpcd = "/media/martin/Innehåller/datafortrain/4/4"+numberstring+"/scan.pcd";  //<--------------- Change number      
  std::string depthlabelrgpcd = "/media/martin/Innehåller/datafortrain/4/4"+numberstring+"/scanlabel.pcd";  //<--------------- Change number      
  string dirnamestr = "/media/martin/Innehåller/datafortrain/4/4"+numberstring;   //<--------------- Change number
   ...
   for(int row=0; row < depth_img.rows; row++)
    {
      ...
      myfile.close();
      pcl::io::savePCDFileASCII(depthlabelrgpcd, *label_cloud);
